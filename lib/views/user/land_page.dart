...
import 'package:winch/views/user/wynch_intro_page.dart';
...
class _LandPageState extends State<LandPage> {
  ...
  getDrawerItem(Subtitle subtitle){
    List<DrawerItemData> _items = [
      ...
      DrawerItemData(label: subtitle.myCars, iconData: WinchIcons.car_of_hatchback_model),
      DrawerItemData(label: subtitle.makeRequest, iconData: WinchIcons.location),
  ...
  void initState() {
    ...
    NotificationManger.initialisation(
            (payload) {
          if(payload!= null){
            _landPageProvider.goToPath(context, Screen.fromJson(json.decode(payload)));
          }
        }
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Theme(
            ...
            child: BottomNavigationBar(
              currentIndex: _landPageProvider.index > 4 ? 2 : _landPageProvider.index,
              selectedItemColor: AColors.black,
              unselectedItemColor: AColors.deepGrey,
              ...
              items: [
                ...
                BottomNavigationBarItem(
                    icon: FaIcon(WinchIcons.car_of_hatchback_model,size: 18,),
                ...
                BottomNavigationBarItem(
                    icon: FaIcon(WinchIcons.phone),
                    label: _subtitle.help
                ),
              ],
              onTap: (_pageIndex){
