...
class WinchRequestTypeLabel extends StatelessWidget {
  final WinchRequestType type;

  const WinchRequestTypeLabel({Key key, this.type}) : super(key: key);
